                  ...
                  <div className="flex gap-2 border-t border-black/10 p-3">
                    ...
                    {order.status === "open" ? (
                      <button
                        ...
                        className="flex-1 rounded-xl bg-red-600 py-3 text-sm font-bold text-black hover:bg-red-700 active:bg-red-800"
                      >
                    ...
                    {order.status === "preparing" ? (
                      <button
                        onClick={() => handleBump(order.id, order.status)}
                        className="flex-1 rounded-xl bg-yellow-500 py-3 text-sm font-bold text-black hover:bg-yellow-600 active:bg-yellow-700"
                      >
                        <span className="flex items-center justify-center gap-2">
                          <span>Ready</span>
                          <span className="tabular-nums text-black">{statusElapsed}</span>
                    ...
                    {order.status === "ready" ? (
                      <button
                        onClick={() => handleBump(order.id, order.status)}
                        className="flex-1 rounded-xl bg-emerald-600 py-3 text-sm font-bold text-black hover:bg-emerald-700 active:bg-emerald-800"
                      >
                        <span className="flex items-center justify-center gap-2">
                          <span>Done</span>
                          <span className="tabular-nums text-black">{statusElapsed}</span>
