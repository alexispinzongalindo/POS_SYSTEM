                ...
                >
                  ...
                  <div className="flex items-center justify-between border-b border-black/10 px-4 py-3">
                    ...
                    <div className="text-right">
                      ...
                      <div
                        className={`text-lg font-bold ${isUrgent ? "text-red-600" : isWarning ? "text-amber-600" : "text-zinc-700"}`}
                      >
                        {elapsed}m
                      </div>
                    </div>
                  ...
                  <div className="flex gap-2 border-t border-black/10 p-3">
                    ...
                    <button
                      ...
                      className={`flex-1 rounded-xl py-4 text-sm font-bold text-white active:opacity-80 ${
                        order.status === "open"
